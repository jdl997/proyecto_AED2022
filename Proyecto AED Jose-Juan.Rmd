...
Equipo Fecha:
Se castea el campo a tipo Date para mejor tratamiento de la variable.
```{r}
...
```{r}
tabla_freq(duplicated(base_filtrada))
```

Se encuentran 12 registros duplicados los cuales se muestran a continuación. Se proceden a eliminarlos.
```{r}
...
base_filtrada$RESULTADO_FINAL[base_filtrada$FECHA == as.Date("2019-03-17") & base_filtrada$EQUIPO_LOCAL== "Panathinaikos"]= "A"
