...
A partir de la investigación respecto al comportamiento de la liga y en consecuencia del objetivo que persigue el presente proyecto de analítica, determinamos que las siguientes `r ncol(base_filtrada)` columnas son de interés para el presente análisis:
...
knitr::kable(tabla_variables, "simple",   col.names = c('VARIABLE', 'TIPO DE VARIABLE', 'Rango o Categorías'), align = "ll", caption = "Tabla. Variables de análisis")
...
base_filtrada$base_filtrada$BbMxH   = as.numeric(base_filtrada$BbMxH)	
