...
```{r}
tabla_variables <- data.frame (unique(base_filtrada$EQUIPO_LOCAL), unique(base_filtrada$EQUIPO_VISITANTE))
knitr::kable(tabla_variables, "simple",   col.names = c('Variable', 'Tipo de variable', 'Rango / Categorías'), align = "llc", caption = "Tabla. Descripción de las Variables para el análisis")

unique(base_filtrada$EQUIPO_LOCAL)
unique(base_filtrada$EQUIPO_VISITANTE)
```
