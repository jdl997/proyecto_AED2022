...
```
> Registros con edades negativas o cero

![](Edades2019.jpg)
> Fuente Informe Icfes.

Adicionalmente, de acuedo con el gráfico anterior, la prueba está caracterizada por el icfes para una población que supera los 15 años, lo cual nos hace suponer que los 22 registros (0,04%)  que indican edades menores a los 15 años, corresponden a anomalías que deben ser verificadas en la fuente y serán incluidas en nuestro informe final. Estos registros sumados a los 52 (0,10%) registros descartados por valores negativos o cero en el cálculo de la edad, representan el 0,14% de la muestra.
...
## Resumen de anomalías {.tabset .tabset-fade .tabset-pills}
