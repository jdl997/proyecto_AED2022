...
base$edad = round(as.numeric(difftime(as.Date("9/09/2016", format="%d/%m/%Y"),base$ESTU_FECHANACIMIENTO, units = "weeks"))/52.17857, digits = 2)
summary(base$ESTU_FECHANACIMIENTO)
```
