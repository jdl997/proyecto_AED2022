...
knitr::kable(tabla_variables, format = "latex", escape = TRUE, "simple", booktabs=T,   col.names = c('Variable', 'Tipo de variable', 'Rango / Categorías'), align = "llc" ) %>%
...
TABLA_EQUIPO_LOCAL =tabla_freq(base_filtrada$RESULTADO_FINAL,0)
